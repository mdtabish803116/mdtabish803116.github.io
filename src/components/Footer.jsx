  ...
  return (
      ...
      <footer className="bg-white dark:bg-cream text-black">
        <div className="mx-auto w-full max-w-screen-xl">
          <div className="grid grid-cols-3 gap-8 px-4 py-6 lg:py-8 md:grid-cols-6">
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold">Community</h2>
              <ul className="flex flex-col gap-2 underline">
                <li className="footerItem">
                  <a className="cta" href="">
                ...
                <li className="footerItem">
                  <a className="cta" href="" aria-label="Events">
                    Events
                  </a>
                </li>
              </ul>
              ...
              <ul className="flex flex-col gap-2 underline">
                ...
                <li className="footerItem">
                  <a
                    ...
                    aria-label="Give Where You Live"
                  >
                    Give Where You Live
                  </a>
                </li>
            ...
            <div>
              <h2 className="mb-6 text-sm font-semibold">Help</h2>
              <ul className="flex flex-col gap-2 underline">
                <li className="footerItem">
                  <a className="cta" >
                    Contact Us
                ...
                <li className="footerItem">
                  <a className="cta"  aria-label="Help Center">
                    Help Center
                  </a>
                </li>
                <li className="footerItem">
            ...
            <div>
              <ul>
                <li className="footerItem">
                  <div className="globalNav__brandMoment">
                    <a>
                      <img
                        className="w-full h-auto"
                        src="https://eep.io/images/yzco4xsimv0y/73ZAoe8O3Y7SXQLeCNTq5u/8ddf1f63b4abdf7f67149d3a9d74a0bd/MCP.svg?w=260&amp;q=70"
                        srcset="https://eep.io/images/yzco4xsimv0y/73ZAoe8O3Y7SXQLeCNTq5u/8ddf1f63b4abdf7f67149d3a9d74a0bd/MCP.svg?w=260&amp;q=70 260w, https://eep.io/images/yzco4xsimv0y/73ZAoe8O3Y7SXQLeCNTq5u/8ddf1f63b4abdf7f67149d3a9d74a0bd/MCP.svg?w=520&amp;q=70 520w"
                        sizes="260px"
                        loading="lazy"
                        alt="Mailchimp Presents"
                        width="289"
                        height="54"
                      />
                    </a>
                    <p className="copy-regular">
                      Films, podcasts, and original series that celebrate the
                      entrepreneurial spirit.
                    </p>
                    <p className="margin--top-c3">
                      <a
        ...
        <div>
          <div>
            {" "}
            <ul
              className="coBrandedLinks flex flex-row gap-4 p-6 justify-center "
              aria-label="Other Intuit Brands"
            >
              <li className="coBrandedLinks__intuit">
                <a
                  aria-label="Intuit"
                  target="_blank"
    ...
    "label":"image_link: intuit"
                ...
                >
                  ...
                  >
                    <path
                      d="M33.6468 4V16H29.5807V4H24.7014V0H38.526V4H33.6468Z"
                      fill="#241C15"
                    ></path>
                    <path
                    ...
                    <path
                      d="M75.1207 4V16H71.0546V4H66.1753V0H80V4H75.1207Z"
                      fill="#241C15"
                    ></path>
                    <path
                    ...
                    ></path>
                    <path
                      d="M59.3647 0H63.4307V16H59.3647V0Z"
                      fill="#241C15"
                    ></path>
                  </svg>
                </a>
              </li>
              <li className="coBrandedLinks__turbotax">
                <a
                  aria-label="Turbo Tax"
                  target="_blank"
                  data-event-handler="manual"
                  onclick='window.tr.pushEvent("e_click", {
    "category":"globalFooter",
    ...
    "label":"image_link: turbotax"
              ...
              <li className="coBrandedLinks__creditkarma">
                <a
                  aria-label="Credit Karma"
                  target="_blank"
                  data-event-handler="manual"
                  onclick='window.tr.pushEvent("e_click", {
    "category":"globalFooter",
    ...
    "label":"image_link: credit karma"
                ...
                >
                  <svg
                    className="brandLogoCreditKarma"
                    width="98"
                    height="17"
                    viewBox="0 0 98 17"
                    fill="none"
              ...
              <li className="coBrandedLinks__quickbooks">
                <a
    ...
    "label":"image_link: quickbooks"
                ...
                >
                  ...
                  >
                    ...
                    <path
                      className="svg_text"
                      d="M36.082 7.03564H37.8984V14.1283H36.082V7.03564Z"
                      fill="#241C15"
                    ></path>
                    <path
                      className="svg_text"
              ...
              <li className="coBrandedLinks__mailchimp">
                <a
    ...
    "label":"image_link: mailchimp"
                ...
                >
                  ...
                  >
                    ...
                    <path
                      className="svg_text"
                      d="M39.9219 6.68848H41.729V13.9771H39.9219V6.68848Z"
                      fill="#241C15"
                    ></path>
                    <path
                      className="svg_text"
                    ...
                    <path
                      className="svg_text"
                      d="M43.543 2.45898H45.3575V13.9388H43.543V2.45898Z"
                      fill="#241C15"
                    ></path>
                    <path
                      className="svg_text"
                    ...
                    <path
                      className="svg_text"
                      d="M62.7656 6.68799H64.5747V13.9766H62.7656V6.68799Z"
                      fill="#241C15"
                    ></path>
                    <path
                      className="svg_text"
          ...
          <div className="gooleplay flex flex-row justify-center gap-10">
            <div class="">
              <ul class="flex flex-row gap-4">
                <li class="">
                  <a >
                    <img
                      src="https://eep.io/images/yzco4xsimv0y/1u3hha7FE0Q402e2qsMu6a/5e403548149c1618b64034284f692ff1/icon-ios.svg?w=160&amp;q=70"
                      srcset="https://eep.io/images/yzco4xsimv0y/1u3hha7FE0Q402e2qsMu6a/5e403548149c1618b64034284f692ff1/icon-ios.svg?w=160&amp;q=70 160w,
          https://eep.io/images/yzco4xsimv0y/1u3hha7FE0Q402e2qsMu6a/5e403548149c1618b64034284f692ff1/icon-ios.svg?w=320&amp;q=70 320w"
                      sizes="(min-width: 37.5em) 320px, 160px"
                      loading="lazy"
                      alt="[KB] Download on the App Store"
                      width="135"
                      height="40"
                    />
                  </a>
                ...
                <li class="cell globalFooter__item--app">
                  <a >
                    <img
                      src="https://eep.io/images/yzco4xsimv0y/64EpnI4RsQI66c2y2O60G2/4c34d7bc4dd7a4362c7e19a06c109e21/icon-android.svg?w=160&amp;q=70"
                      srcset="https://eep.io/images/yzco4xsimv0y/64EpnI4RsQI66c2y2O60G2/4c34d7bc4dd7a4362c7e19a06c109e21/icon-android.svg?w=160&amp;q=70 160w,
          https://eep.io/images/yzco4xsimv0y/64EpnI4RsQI66c2y2O60G2/4c34d7bc4dd7a4362c7e19a06c109e21/icon-android.svg?w=320&amp;q=70 320w"
            ...
            <div>
              {" "}
              <ul className="cell socialMedia flex flex-row gap-4">
                <li className="globalFooter__item--social">
                  <a
                    aria-label="Facebook"
                    data-characterize-click="footer_social:facebook"
                    data-tracking-event="share"
                    data-tracking-method="facebook"
                  >
                    <img
                      src="https://eep.io/images/yzco4xsimv0y/5daYAeMRSgIUUiSquGwsgI/c4f1bcaa7f06c0dbf66158331144eaf5/icon-facebook-21-20.svg?w=160&amp;q=70"
                      srcset="
              https://eep.io/images/yzco4xsimv0y/5daYAeMRSgIUUiSquGwsgI/c4f1bcaa7f06c0dbf66158331144eaf5/icon-facebook-21-20.svg?w=160&amp;q=70 160w,
              https://eep.io/images/yzco4xsimv0y/5daYAeMRSgIUUiSquGwsgI/c4f1bcaa7f06c0dbf66158331144eaf5/icon-facebook-21-20.svg?w=320&amp;q=70 320w
            "
                      sizes="(min-width: 37.5em) 320px, 160px"
                      loading="lazy"
                      alt="Facebook"
                ...
                <li className="globalFooter__item--social">
                  <a
                    aria-label="Twitter"
                    data-characterize-click="footer_social:twitter"
                    data-tracking-event="share"
                    data-tracking-method="twitter"
                  >
                    <img
                      src="https://eep.io/images/yzco4xsimv0y/3VjJhbqftKuok6gqYuUQKy/b19aae83616891ee31ca7f801dcbb77d/icon-twitter-20-20.svg?w=160&amp;q=70"
                      srcset="
              https://eep.io/images/yzco4xsimv0y/3VjJhbqftKuok6gqYuUQKy/b19aae83616891ee31ca7f801dcbb77d/icon-twitter-20-20.svg?w=160&amp;q=70 160w,
              https://eep.io/images/yzco4xsimv0y/3VjJhbqftKuok6gqYuUQKy/b19aae83616891ee31ca7f801dcbb77d/icon-twitter-20-20.svg?w=320&amp;q=70 320w
            "
                      sizes="(min-width: 37.5em) 320px, 160px"
                      loading="lazy"
                ...
                <li className="globalFooter__item--social">
                  <a
                    ...
                    data-characterize-click="footer_social:instagram"
                    data-tracking-event="share"
                    data-tracking-method="instagram"
                  >
                    <img
                      src="https://eep.io/images/yzco4xsimv0y/RlNw7Xkw8uKYAUoYU4aQw/e6b336e1e536e5ffccdc1654448d3c79/icon-instagram-21-20.svg?w=160&amp;q=70"
                      srcset="
              https://eep.io/images/yzco4xsimv0y/RlNw7Xkw8uKYAUoYU4aQw/e6b336e1e536e5ffccdc1654448d3c79/icon-instagram-21-20.svg?w=160&amp;q=70 160w,
              https://eep.io/images/yzco4xsimv0y/RlNw7Xkw8uKYAUoYU4aQw/e6b336e1e536e5ffccdc1654448d3c79/icon-instagram-21-20.svg?w=320&amp;q=70 320w
            "
                      sizes="(min-width: 37.5em) 320px, 160px"
                      loading="lazy"
                      alt="Instagram"
                ...
                <li className="globalFooter__item--social">
                  <a
                    aria-label="LinkedIn"
                    data-characterize-click="footer_social:linkedin"
                    data-tracking-event="share"
                    data-tracking-method="linkedin"
                  >
                    <img
                      src="https://eep.io/images/yzco4xsimv0y/n5saFR4miW4U4ygUIQo0A/f396bbf6610cc219e2e50a130010378c/icon-linkedin-20-20.svg?w=160&amp;q=70"
                      srcset="
              https://eep.io/images/yzco4xsimv0y/n5saFR4miW4U4ygUIQo0A/f396bbf6610cc219e2e50a130010378c/icon-linkedin-20-20.svg?w=160&amp;q=70 160w,
              https://eep.io/images/yzco4xsimv0y/n5saFR4miW4U4ygUIQo0A/f396bbf6610cc219e2e50a130010378c/icon-linkedin-20-20.svg?w=320&amp;q=70 320w
            "
                      sizes="(min-width: 37.5em) 320px, 160px"
                      loading="lazy"
                      alt="LinkedIn"
                ...
                <li className="globalFooter__item--social">
                  <a
                    aria-label="YouTube"
                    data-characterize-click="footer_social:youtube"
                    data-tracking-event="share"
                    data-tracking-method="youtube"
                  >
                    <img
                      src="https://eep.io/images/yzco4xsimv0y/2z1ra9BrgQewIqMQckMasg/61893a8beccd98808e4f8083d5a19764/icon-youtube-29-20-White__1_.svg?w=160&amp;q=70"
                      srcset="
              https://eep.io/images/yzco4xsimv0y/2z1ra9BrgQewIqMQckMasg/61893a8beccd98808e4f8083d5a19764/icon-youtube-29-20-White__1_.svg?w=160&amp;q=70 160w,
              https://eep.io/images/yzco4xsimv0y/2z1ra9BrgQewIqMQckMasg/61893a8beccd98808e4f8083d5a19764/icon-youtube-29-20-White__1_.svg?w=320&amp;q=70 320w
            "
                      sizes="(min-width: 37.5em) 320px, 160px"
                      loading="lazy"
                      alt="YouTube"
                ...
                <li className="globalFooter__item--social">
                  <a
                    ...
                    data-characterize-click="footer_social:pinterest"
                    data-tracking-event="share"
                    data-tracking-method="pinterest"
                  >
                    <img
                      src="https://eep.io/images/yzco4xsimv0y/7nawBEArBKpxRukK66OZtN/2f0650df51c47298c6612737af44f22d/pinterest-logo-20-20.svg?w=160&amp;q=70"
                      srcset="
              https://eep.io/images/yzco4xsimv0y/7nawBEArBKpxRukK66OZtN/2f0650df51c47298c6612737af44f22d/pinterest-logo-20-20.svg?w=160&amp;q=70 160w,
              https://eep.io/images/yzco4xsimv0y/7nawBEArBKpxRukK66OZtN/2f0650df51c47298c6612737af44f22d/pinterest-logo-20-20.svg?w=320&amp;q=70 320w
            "
                      sizes="(min-width: 37.5em) 320px, 160px"
                      loading="lazy"
                      alt="Pinterest"
            ...
            <div className="gdprBadge">
              <a >
                <img
                  src="https://eep.io/images/yzco4xsimv0y/5YvMZrsHz6u8Xl3dbjlPWD/d795b8d01679466c44f5938cde4ac046/EN.svg?w=1600&amp;q=70"
                  sizes="(min-width: 1600px) 1600px, 100vw"
                  loading="lazy"
                  alt="GDPR Friendly Tools"
                  width="102"
                  height="40"
                />
              </a>
              ...
              <div className="flex flex-row justify-center flex-wrap p-8 ">
                <div className="">
                  <div className="margin--right-c3 margin--bottom-c3 screen-reader-only">
                    <label
                      for="languagePicker-2010706056"
                      className="formLabel formLabel--select"
                    >
                      This page is now available in other languages.
                    </label>
                  </div>
                  <div className="formSelect formSelect--small-secondary bg-cream">
                    <select
                      name="languagePicker"
                      id="languagePicker-2010706056"
                      data-behavior="languagePicker"
                      fdprocessedid="luu1qp"
                      className="bg-cream hover:bg-white"
                    >
                      <option value="/" data-locale="en" selected="selected">
                        English
                      </option>
